...
const RDWallet = () => {
    ...
    const fetchTransactions = async (page = currentPage, limit = itemsPerPage, filters = {}) => {
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/wallets/rd-transactions`, {
                params,
                headers: {
            ...
            console.error("Error fetching RD wallet transactions:", err);
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-amber-500 to-amber-700 rounded-lg shadow-lg overflow-hidden mb-8">
                    <div className="p-6">
                        <h1 className="text-white font-bold text-3xl mb-2">RD Wallet</h1>
                        <p className="text-amber-100 mb-4">Recurring Deposit Account</p>
                        
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center mt-4">
                            <div>
                                <div className="text-white text-4xl font-bold">₹{userdata?.rd_wallet?.balance || '0.00'}</div>
                                <div className="text-amber-100 text-sm mt-1">Available Balance</div>
                            </div>
                            
                            <div className="mt-4 md:mt-0 flex space-x-3">
                                <button className="bg-white text-amber-700 px-6 py-2 rounded-md hover:bg-amber-50 transition-colors duration-200 font-medium">
                                    Deposit
                                </button>
                                <button className="bg-amber-800 text-white px-6 py-2 rounded-md hover:bg-amber-900 transition-colors duration-200 font-medium">
                                    Withdraw
                                </button>
                            </div>
                        </div>
                                                ...
                                                return (
                                                    <React.Fragment key={page}>
                                                        ...
                                                        <button
                                                            ...
                                                            className={`px-3 py-1 rounded-md ${currentPage === page ? 'bg-amber-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                                                        >
                                                            {page}
                                                        </button>
